...
export const DashboardContent: React.FC = () => {
  ...
  const showProfilePrompt = user?.userType === 'agent' && !user?.profileCompleted;
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 mb-4">
                  Pour profiter pleinement de HubImmo et collaborer avec d&apos;autres professionnels, 
                  veuillez compléter les informations de votre profil d&apos;agent immobilier.
                </p>
