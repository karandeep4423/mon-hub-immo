				...
				<div className="border border-gray-200 rounded-lg p-6 bg-white">
					...
					<div className="space-y-4">
						<Input
							...
							type="text"
							value={
								clientInfo.qualificationInfo?.clientName || ''
							}
							onChange={(e) =>
								handleNestedChange(
									'qualificationInfo',
						...
						<Select
							...
							value={
								clientInfo.qualificationInfo?.clientStatus || ''
							}
						...
						<Input
							...
							type="text"
							value={
								clientInfo.qualificationInfo?.profession || ''
							}
							onChange={(e) =>
								handleNestedChange(
									'qualificationInfo',
				...
				<div className="border border-gray-200 rounded-lg p-6 bg-white">
					...
					<div className="space-y-4">
						...
						<Input
							...
							type="text"
							value={
								clientInfo.timelineInfo?.idealMoveInDate || ''
							}
							onChange={(e) =>
								handleNestedChange(
									'timelineInfo',
