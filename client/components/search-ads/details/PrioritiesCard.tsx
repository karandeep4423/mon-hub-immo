...
export const PrioritiesCard: React.FC<PrioritiesCardProps> = ({ searchAd }) => {
	...
	return (
		<div className="bg-white p-5 rounded-xl shadow-md border border-gray-200/50 hover:shadow-xl hover:border-brand-200 transition-all duration-300 lg:col-span-2">
