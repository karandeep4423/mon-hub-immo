...
export const ClientInfoForm: React.FC<ClientInfoFormProps> = ({
	...
	return (
		<FormProvider isSubmitting={disabled}>
			<div className="space-y-8">
				...
				<div className="border border-gray-200 rounded-lg p-6 bg-white">
					...
					<div className="space-y-4">
						<div>
							<Textarea
								label="Quels sont les points forts à mettre en avant selon le vendeur ?"
								value={
						...
						<div className="flex items-center space-x-2">
							...
							>
								Le propriétaire est-il ouvert à une offre
								&quot;coup de coeur&quot; même si elle est un
								peu en dessous du prix affiché ?
							</label>
						</div>
					</div>
				</div>
				...
				<div className="border border-gray-200 rounded-lg p-6 bg-white">
					...
					<div className="space-y-4">
						...
						<Input
							...
							type="text"
							value={
								clientInfo.propertyHistory?.lastVisitDate || ''
							}
							onChange={(e) =>
								handleNestedChange(
									'propertyHistory',
						...
						<div>
							<Textarea
								label="Retour des précédents visiteurs (objections, freins éventuels)"
								value={
						...
						<div>
							<Textarea
								label="Historique des baisses de prix ou ajustements"
								value={
									clientInfo.propertyHistory
										?.priceReductions || ''
								}
